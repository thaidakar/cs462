ruleset manage_sensors {
    ...
    rule query_sensors {
        ...
        pre {
            result = ent:sensors.map(function(something, sensor_id, x) {
                a = something.klog("something = ")
                b = sensor_id.klog("sensor_id = ")
                c = x.klog("x = ")
                answer = wrangler:picoQuery(a{"eci"},"temperature_store","temperatures");
